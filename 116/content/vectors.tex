\subsubsection*{Coordinate Direction Angles}
...
\subsubsection*{Transverse \& Azimuthal Angles}
...
\subsubsection*{Reduction to a wrench}
1. Draw diagram\\
...
\subsubsection*{Rigid Body Equilibrium (2D)}
$\sum F_x = 0 \qquad \sum F_y = 0 \qquad \sum M_O = 0$

\subsubsection*{Rigid Body Equilibrium (3D)}
